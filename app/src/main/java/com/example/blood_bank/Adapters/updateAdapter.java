...
public class updateAdapter extends RecyclerView.Adapter<updateAdapter.Viewholder> {
    ...
    public updateAdapter(Donors_ShowActivity donors_showActivity, ArrayList<donorClass> donorArray) {
    ...
    public updateAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.alert_dialog_update,parent,false);
